  ...
  return class extends React.PureComponent {
    ...
    async componentDidMount() {
      ...
      try {
        ...
        this.setState({ localFilePath: url });
      }
    }
    ...
    async _loadImage(url) {
      ...
      try {
        ...
        if (this.props.onLoadFinished)
          if(!this.InvalidUrl && Platform.OS === "android")
            await Image.getSize("file://" + localFilePath, (width, height) => this.props.onLoadFinished(width, height));
          else 
            await Image.getSize(localFilePath, (width, height) => this.props.onLoadFinished(width, height));
      } catch (error) {
    ...
    render() {
      ...
      if (this.state.localFilePath) {
        ...
        let localFileUri;
        if (!this.InvalidUrl && !this.state.localFilePath.includes('http')) {
